...
<template>
  <div class="home-layout">
        ...
        <div id="photo-analysis" class="scroll-reveal ai-feature-row">
          <div class="ai-feature-text">
            ...
            <p class="mt-3 text-base" style="color: var(--vp-c-text-2)">
              Upload a photo and AI identifies every item with quantities. Accept or edit each suggestion independently. Re-analyze with a correction to refine results.
            </p>
            <div class="ai-pills mt-4">
              ...
              <span class="ai-pill" style="background: var(--vp-c-brand-soft); color: var(--vp-c-brand-3)">Quantities</span>
    ...
    <section id="providers" class="px-6 py-16" style="background: var(--vp-c-bg-soft)">
      <div class="mx-auto max-w-5xl text-center">
        <h2 class="display-heading scroll-reveal mb-2 text-3xl lg:text-4xl">
          Your AI. Your choice.
        </h2>
        <p class="scroll-reveal mb-10 text-lg">
          Works with the providers you already trust. Mix and match per task.
        </p>

        <!-- Provider cards -->
        <div class="scroll-reveal flex flex-wrap justify-center gap-6 mb-10">
          <div class="ai-provider-card stagger-1">
          ...
          <div class="ai-provider-card stagger-2">
            <div class="ai-provider-logo">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M17.304 4.051c-1.456-.48-3.024-.186-4.2.792L12 5.774l-1.104-.93C9.72 3.863 8.152 3.57 6.696 4.05 5.04 4.596 3.84 6.108 3.84 7.86v.012c0 .72.156 1.404.444 2.04H2.4A1.2 1.2 0 0 0 1.2 11.1v1.8c0 .66.54 1.2 1.2 1.2h.6v5.1a1.8 1.8 0 0 0 1.8 1.8h14.4a1.8 1.8 0 0 0 1.8-1.8v-5.1h.6a1.2 1.2 0 0 0 1.2-1.2V11.1a1.2 1.2 0 0 0-1.2-1.188h-1.884c.288-.636.444-1.32.444-2.04V7.86c0-1.752-1.2-3.264-2.856-3.81z"/></svg>
            </div>
            <span class="ai-provider-name">Anthropic</span>
          </div>
          <div class="ai-provider-card stagger-3">
            <div class="ai-provider-logo">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M11.04 19.32L4.56 8.16h4.08l3.36 5.76 3.36-5.76H19.44l-6.48 11.16H11.04z"/></svg>
            </div>
            <span class="ai-provider-name">Google Gemini</span>
          </div>
          <div class="ai-provider-card stagger-4">
            <div class="ai-provider-logo" style="color: var(--vp-c-text-3)">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v8"/><path d="M8 12h8"/></svg>
            </div>
            <span class="ai-provider-name">Any compatible</span>
          </div>
        </div>

        <!-- Task routing card -->
        <div class="scroll-reveal mx-auto max-w-lg">
          <div class="ai-demo-card" style="text-align: left">
            <div class="ai-demo-header">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: var(--vp-c-brand-3)">
                <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>
              </svg>
              <span>Task Routing Example</span>
            </div>
            <div class="ai-routing-grid">
              <div class="ai-routing-row">
                <span class="ai-routing-dot" style="background: var(--vp-c-brand-3)"></span>
                <span class="ai-routing-group">Vision</span>
                <span class="ai-routing-arrow">&rarr;</span>
                <span class="ai-routing-model">Gemini Flash — fast, multimodal</span>
              </div>
              <div class="ai-routing-row">
                <span class="ai-routing-dot" style="background: #60a5fa"></span>
                <span class="ai-routing-group">Quick Text</span>
                <span class="ai-routing-arrow">&rarr;</span>
                <span class="ai-routing-model">Claude Haiku — cheap, fast</span>
              </div>
              <div class="ai-routing-row">
                <span class="ai-routing-dot" style="background: #4ade80"></span>
                <span class="ai-routing-group">Deep Text</span>
                <span class="ai-routing-arrow">&rarr;</span>
                <span class="ai-routing-model">Claude Sonnet — best reasoning</span>
              </div>
            </div>
          </div>
        </div>
