...
onMounted(() => {
  ...
  // Demo iframe scale
  if (demoWrapper.value) {
    const updateDemoScale = () => {
      const next = demoWrapper.value.clientWidth / DEMO_W
      if (next !== demoScale.value) demoScale.value = next
    }
    demoResizeObs = new ResizeObserver(updateDemoScale)
    demoResizeObs.observe(demoWrapper.value)
    updateDemoScale()
  }
      ...
      <div class="animate-in delay-5 mx-auto mt-12 max-w-5xl">
        <div class="relative hidden lg:block">
          <div class="device-frame">
            <div class="device-frame-screen" ref="demoWrapper">
              <div :style="{ height: Math.round(DEMO_H * demoScale) + 'px' }">
                <iframe
      ...
      <div class="mx-auto max-w-5xl">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          >
            ...
            <p class="mt-2 text-sm font-medium" style="color: var(--vp-c-brand-3)">Free forever · Plus from $4/mo</p>
