...
Members can't delete bins, including ones they created. To delete a bin, an admin moves it to Trash from the bin detail page. Members who need a bin removed should ask an admin.
:::
